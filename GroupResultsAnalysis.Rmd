...
```{r Chart_bar_Percentages, echo=FALSE, message=FALSE,fig.height=12, fig.cap="", dpi=300}
...
```{r GroupClassificationAtLeastOne, child='GroupClassificationAtLeastOne_text.Rmd', eval = !HideClassificationInformation}
```

```{r GroupClassificationEveryWristband, child='GroupClassificationEveryWristband_text.Rmd', eval = !HideClassificationInformation}
```
...
```{r chart_total_ng_found, echo=FALSE, message=FALSE, fig.height=12,fig.cap="",dpi=150}
################BEGIN x5 Perc
...
```{r print_loreal_venn, child='loreal_venn_text.Rmd', eval=FALSE}
```
