    ...
    if (nrow(testResults_ChemOfConcern) > 1) {
      ...
      if (nrow(testInChemSourceMitigation) > 0) {
        chemSourceMitigationMessage <- paste0(
          "\n\nThis compound is known to have the following health effects: **", testInChemSourceMitigation$Summary_of_Health_Effects, "**. ",
          "This compound is known to be found in the following commercial products:  **", testInChemSourceMitigation$Commercial_Products, "**. ",
          "Possible ways to avoid exposure to this compound include: **", testInChemSourceMitigation$Mitigation_Strategies, "**."
        )
        newMessage <- paste(
          newMessage,
          " ",
  ...
  for (i in 1:length(chemsNOTinConcernGroup)) {
    ...
    if (nrow(testResults_ChemNOTinConcern) > 1) {
      ...
      if (nrow(testInChemSourceMitigation) > 0) {
        ...
        chemSourceMitigationMessage <- paste0(
          chemSourceMitigationMessage,
          "This compound is known to have the following health effects: **",
          testInChemSourceMitigation$Summary_of_Health_Effects,
          "**. ",
          "This compound is known to be found in the following commercial products:  **",
          testInChemSourceMitigation$Commercial_Products,
          "**. ",
