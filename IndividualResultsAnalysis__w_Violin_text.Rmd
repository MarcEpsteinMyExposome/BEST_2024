...
#plotly::config(plot_ly())
plotly::config(plot_ly())
# suppressMessages( plotly::config(
#     displayModeBar = TRUE,    
#     displaylogo = FALSE,
...
plotlyC <- suppressMessages( plotlyChems(chemsOfConcern, testResults.big, oneResultCalifProp65Risk, oneResultEpaIris, oneResultIARCRisk, chemSourceMitigation))
#cat(" \n about print ploty \n")
