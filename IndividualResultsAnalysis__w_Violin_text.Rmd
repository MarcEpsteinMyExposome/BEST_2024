...
if (length(chemsNOTinConcernGroup >= 1)) {
  for (i in 1:length(chemsNOTinConcernGroup)) {
    ...
    #chemNOTinConcernGroup <- chemsNOTinConcernGroup[1]
...
#        Prop65_Link <- paste0("<a href='", Prop65_Link, "' target='_blank'>", Prop65_Link, "</a>") ## This should make the link open in new tab
        ...
        #   wikiURL <- testInChemSourceMitigation$WIKIPEDIA_ARTICLE_URL
        #   wikiURL <- paste0("<a href='", wikiURL, "' target='_blank'>", wikiURL, "</a>") ## This should make the link open in new tab
        #   wikiMessage <-paste0( "\n Additional information about this compound can be found on this wikipedia article: ",wikiURL)
        #   chemSourceMitigationMessage <- paste0(chemSourceMitigationMessage," ",wikiMessage,"\n")
        # }
        ...
        if (!is.na(testInChemSourceMitigation$WIKIPEDIA_ARTICLE_URL)) {
          ...
          #wikiURL <- paste0("<a href='", wikiURL, "' target='_blank'>", wikiURL, "</a>") ## This should make the link open in new tab
          wikiURL <- makeClickableURL(wikiURL, "Wiki")
          wikiMessage <- paste0(" Additional information: ", wikiURL)
          chemSourceMitigationMessage <- paste0(chemSourceMitigationMessage, " ", wikiMessage, "\n")
        }
