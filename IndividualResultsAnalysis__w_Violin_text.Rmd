...
if(length(chemsOfConcern>=1)){
  for (i in 1:length(chemsOfConcern)) {
    ...
    if (nrow(testResults_ChemOfConcern)>1) {
      ...
      cat('Your chemical ',chemOfConcern,' was found in such and such Database which I will add by pulling info from a database and giving a link as well')
...
We are looking up all the chemicals you tested positive for that are listed in any of (1) The EPA's Integrated Risk Information System (IRIS) is a human health assessment program, (2) The California Proposition 65 chemical database which categorizes many different chemicals with respect to toxicity (potential hazard), and (3) Chemicals classified by the International Agency for the Research on Cancer which categorizes many different chemicals with respect to types of cancer risks
...
cat("+ Group 1: The agent is carcinogenic to humans:  This category is used when there is sufficient evidence of carcinogenicity in humans.")
cat("+ Group 2A: The agent is probably carcinogenic to humans:  This category is used when there is limited evidence of carcinogenicity in humans and sufficient evidence of carcinogenicity in experimental animals. ")
cat("+ Group 2B: The agent is possibly carcinogenic to humans:  This category is used for agents for which there is limited evidence of carcinogenicity in humans and less than sufficient evidence of carcinogenicity in experimental animals. ")
...
cat("+ Group 4: The agent is probably not carcinogenic to humans: This category is used for agents for which there is evidence suggesting lack of carcinogenicity in humans and in experimental animals. ")
