...
```{r GroupDatabaseLookupReporting, child=setRMDdirectory('GroupDatabaseLookupIARC_Prop65_IRIS.Rmd'), eval = DoGroupDatabaseLookupReporting}
```
...
```{r GroupChemicalListWithClassification, child=setRMDdirectory('GroupChemicalListWithClassification_text.Rmd'), eval = !HideClassificationInformation}
```

```{r GroupChemicalListWithOutClassification, child=setRMDdirectory('GroupChemicalListWithOutClassification_text.Rmd'), eval = HideClassificationInformation}
```

```{r GroupAirConcentrationNioshOsha, child=setRMDdirectory('airConcentrationOutput.Rmd'), eval = doAIRplusNioshOSHAreporting}
```

```{r GroupClassificationAnyWristband, child=setRMDdirectory('GroupClassificationAnyWristband_text.Rmd'), eval = !HideClassificationInformation}
```


<!-- I MADE THIS FALSE FOR DEBUGGING -->
```{r StatisticsOnGroupAllChemicalsFound, child=setRMDdirectory('StatisticGroupsOnChemicalsFound.Rmd'), eval = TRUE}
```
...
```{r GroupGroupClassificationAtLeastOne, child=setRMDdirectory('GroupClassificationAtLeastOne_text.Rmd'), eval = !HideClassificationInformation}
```

```{r GroupGroupClassificationEveryWristband, child=setRMDdirectory('GroupClassificationEveryWristband_text.Rmd'), eval = !HideClassificationInformation}
```
...
```{r print_loreal_vennGroup, child=setRMDdirectory('loreal_venn_text.Rmd'), eval=FALSE}
```
