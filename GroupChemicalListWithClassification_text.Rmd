...
The following list of chemicals, along with their classification(s), were found on at least one of the wristbands in this study.
...
names(AllResultClassified) <- c("Chemical Name", "CAS Number", "Classification(s)")
