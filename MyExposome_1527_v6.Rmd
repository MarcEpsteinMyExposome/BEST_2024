...
if (!exists("buildMesgV")) {
  source(here("R",support.functions.filename))
}
#cat("222 Starting the RMarkdown execution...\n", file = "debug_log.txt", append = TRUE)
