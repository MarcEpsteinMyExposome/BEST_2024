...
•	8       ¦--IndividualResultsAnalysis__w_Violin_text.Rmd    -- THIS GOT TWEAKED INTO TWO PARTS          
...
MyExposome_1527_v6.Rmd
  ...
  - Child RMD Files:
    ...
    - IndividualResultsAnalysis__w_Violin_Precursor.Rmd
      - Sourced R Files:
        - BuildViolinPlot_SinaOnly.R
    - HeadlineMessageTotalChems.Rmd
    - HeadlinesAmountByChemicalGroup.Rmd
      - Sourced R Files:
        - HeadlinesAmountByChemicalGroup_R_Code.R
    - IndividualResultsAnalysis__w_Violin_Output.Rmd
      - Child RMD Files:
...
```{r IndividualResultsAnalysis, child='IndividualResultsAnalysis__w_Violin_Output.Rmd', eval= DoSpecificSubjectAnalysis}
```
