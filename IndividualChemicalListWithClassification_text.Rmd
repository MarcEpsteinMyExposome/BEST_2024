...
The following list of chemicals, along with their classifications, were found in your wristband:

To see an explanation of **Classifications** and a discussion of likely sources of any exposure and ways to minimize exposure :  [Click Here](#class_link_id)

### Chemicals showing Classifications
...
names(oneResultClassified)<-c("Chemical Name", "CAS Number","Classification(s)")
