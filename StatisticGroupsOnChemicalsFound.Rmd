...
```{r setupbsYY_modal_std_dev3Group, echo=FALSE}
...
```{r print_not_time_or_weight_adjustGroup, results="asis", echo=FALSE, eval=!(wristbands_weight_adjusted || wristbands_time_adjusted)}
cat("The data is the raw nanograms found in each wristband. ", sep = "")
```

```{r print_weight_only_adjust1Group, results="asis", echo=FALSE, eval=wristbands_weight_adjusted}
cat("The data is the raw nanograms found in each gram of wristband. ", sep = "")
```

```{r print_loreal_4xGroup, results="asis", echo=FALSE, eval=wristbands_time_adjusted_one_week_not_weight}
...
```{r print_loreal_4x3Group, results="asis", echo=FALSE, eval=wristbands_week_and_weight_adjusted}
...
```{r print_loreal_4x2Group, results="asis", echo=FALSE, eval=(wristbands_time_adjusted_one_day & FALSE) }
...
```{r StatSummaryGroup, results='asis', echo=FALSE, eval=TRUE, message=FALSE}
