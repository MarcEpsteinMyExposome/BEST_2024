...
Our `r testName`  tests for **`r howManyChemicalsTested`** chemicals. We have classified these chemicals into a few categories to make these results easier to understand.
