...
bs_modal(id = "StandardDeviation3", title = "Standard Deviation Definition", body = "Standard deviation is a measure of how spread out all the results are from the average. A bigger standard deviation means the numbers are more spread out, while a smaller one means they're closer to the average.")
