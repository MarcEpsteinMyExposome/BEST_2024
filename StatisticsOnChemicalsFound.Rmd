...
One key way to view the data is by looking at the smallest, largest, average, and middle values for each chemical, how many wristbands it was found on, and the [standard deviation](## "Standard deviation is a measure of how spread out the numbers in a set are from the average. A bigger standard deviation means the numbers are more spread out, while a smaller one means they're closer to the average.").
